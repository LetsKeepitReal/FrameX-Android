...
<p align="center">
  ...
  <a href="https://github.com/MaheshSharan/FrameX-Android/releases/tag/v1.5.14">
    <img src="https://img.shields.io/badge/Version-1.5.14-orange?style=for-the-badge&logo=github" alt="Version"/>
  </a>
...
> 1. Clone the repository and install the **Debug APK** (`./gradlew installDebug`) or download **[FrameX-v1.5.14-debug.apk](https://github.com/MaheshSharan/FrameX-Android/releases/download/v1.5.14/FrameX_v1.5.14-debug.apk)**. *(Release builds strip diagnostic logs via ProGuard).*
